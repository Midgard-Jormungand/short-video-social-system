...
val scalaV = "2.12.4"
//val scalaV = "2.11.8"
val projectName = "svss"
val projectVersion = "0.0.2.a"

resolvers += Resolver.sonatypeRepo("snapshots")


val projectMainClass = "com.neo.sk.svss.Boot"
...
lazy val frontend = (project in file("frontend"))
  ...
  .settings(
    ...
    //mainClass := Some("com.neo.sk.svss.front.Main"),
...
lazy val backend = (project in file("backend")).enablePlugins(PackPlugin)
  ...
  .settings(
    ...
    javaOptions in reStart += "-Xmx768m"
  )
  ...
  .settings(
    ...
    packMain := Map("svss" -> projectMainClass),
    packJvmOpts := Map("svss" -> Seq("-Xmx64m", "-Xms32m")),
    packExtraClasspath := Map("svss" -> Seq("."))
  )
  .settings(
